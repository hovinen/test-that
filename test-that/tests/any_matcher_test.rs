...
#[test]
fn matches_value_with_first_of_two_matching_components() -> TestResult<()> {
    verify_that!("A string", any!(starts_with("A"), starts_with("string")))
}

#[test]
fn matches_value_with_second_of_two_matching_components() -> TestResult<()> {
...
#[test]
fn formats_error_message_correctly_when_any_is_inside_some() -> TestResult<()> {
    let value = Some(4);
...
#[test]
fn formats_error_message_correctly_when_any_is_inside_ok() -> TestResult<()> {
...
#[test]
fn formats_error_message_correctly_when_any_is_inside_err() -> TestResult<()> {
