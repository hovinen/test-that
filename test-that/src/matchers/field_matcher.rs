...
/// verify_that!(my_struct, field!(MyStruct.a_vec, [eq(1), gt(1), le(4)]))
/// #    .unwrap();
/// ```
///
...
///
/// let my_struct = MyStruct { a_vec: vec![1, 2, 3] };
/// verify_that!(my_struct, field!(MyStruct.a_vec, {eq(3), gt(1), eq(1)}))
/// #    .unwrap();
/// ```
///
...
/// verify_that!(my_struct, field!(
///     MyStruct.maybe_a_vec,
